...
// 在这里，我们创建了一个名为 Cat 的 models，它在数据库中的名字根据传给 mongoose.models 的第一个参数决定，mongoose 会将名词变为复数，在这里，collection 的名字会是 `cats`。
// 这个 models 的定义是，有一个 String 类型的 name，String 数组类型的 friends，Number 类型的 age。
